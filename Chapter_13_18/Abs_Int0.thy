...
fixes num' :: "val \<Rightarrow> 'av"
  ...
  and less' :: "'av \<Rightarrow> 'av \<Rightarrow> bool option"
assumes gamma_num': "i \<in> \<gamma>(num' i)"
  and gamma_plus': "\<lbrakk>i1 \<in> \<gamma> a1; i2 \<in> \<gamma> a2\<rbrakk> \<Longrightarrow> i1+i2 \<in> \<gamma>(plus' a1 a2)"
  and gamma_less': "\<lbrakk>i1 \<in> \<gamma> a1; i2 \<in> \<gamma> a2\<rbrakk> \<Longrightarrow> less' a1 a2 = None \<or> less' a1 a2 = Some (i1 < i2)"
